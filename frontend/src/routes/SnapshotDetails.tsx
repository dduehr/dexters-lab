                ...
                <div className="card-header">
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb mb-0">
                            ...
                            <li className="breadcrumb-item"><Link to="#">Cup Noodle USB Warmer</Link></li>
                            <li className="breadcrumb-item"><Link to="#">main</Link></li>
                            <li className="breadcrumb-item active" aria-current="page">Snapshot Details</li>
                        </ol>
                    </nav>
                </div>
                <div className="card-body">
                    <h3>Snapshot from 02.11.2023 09:47:29</h3>
                    <form>
                        <div className="mb-3">
                        ...
                        <div className="mb-3">
                            ...
                            <textarea className="form-control" id="comment" rows={3} readOnly value="Some comments ..." />
                        </div>
                        <div className="mb-3">
                        ...
                        <div className="mb-4">
                            ...
                            <input type="text" className="form-control" id="created-at" readOnly value="02.11.2023 09:47:29" />
                        </div>
